...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Appumwol',
    ...
    BOT_INFO: process.env.BOT_INFO || 'appumowl;unni;9995797137;https://i.imgur.com/92oyohN.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'appumowl;unni;https://i.imgur.com/92oyohN.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'appumowl;unni' : process.env.STICKER_DATA,
